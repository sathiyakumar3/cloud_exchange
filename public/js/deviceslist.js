            ...
            for (i in total_op) {
                ...
                if (tempname != "Cloud_Exchange") {
                    ...
                    var myvar ='<div class="table-responsive"><table   id="edit_datable_' + tempname + '" class="table table-hover display  mb-30 dataTable no-footer"  width="100%" style="cursor: pointer;" role="grid" aria-describedby="edit_datable_2_info">' +
                        ...
                        '<i class="fas fa-ticket-alt"></i><span class="btn-text">Open Ticket</span></button></div></div></div> </thead>' +
                        '<tbody><div class="row dis-inl remove-mg"><div class="col-sm-12 dis-inl row-mg-left"><h6 class="dis-inl">Available Users : &nbsp;&nbsp&nbsp;&nbsp</h6><div class="dis-inl" id="currentusers_' + tempname + '"</div></div><div class="row dis-inl"><div class=""><h6 class="dis-inl">Description : &nbsp;&nbsp&nbsp;&nbsp</h6><div class="dis-inl" id="description_' + tempname + '"</div></div><div class="row dis-inl"><div class=""><h6 class="dis-inl">Site : &nbsp;&nbsp&nbsp;&nbsp</h6><div class="dis-inl" id="title_' + tempname + '"</div></div></tr></tbody></table > </div>  <select class="form-control tkt-opt-hide" id="combo_' + tempname + '"></select >';
