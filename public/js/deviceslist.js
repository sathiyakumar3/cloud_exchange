            ...
            for (i in total_op) {
                ...
                tempicon = getsiteicon(temptype); if (tempname != "Cloud_Exchange") {
                    ...
                    var myvar = '<table id="edit_datable_' + tempname + '" class="table table-hover display mb-30 dataTable no-footer"  width="100%" style="cursor: pointer;" role="grid" aria-describedby="edit_datable_2_info">' +
                        '<thead><div class="row"><div class="col-sm-2 row-mg-left "><div class="pull-left pull-left-mg"><div style="clear: both" class="tkt-tot"><h6 style="float: left"> Last Ticket : </h6> &nbsp; &nbsp;' +
                        ' <h6 class="label label-info text-bg-round" style="float: right" id="currentticket_' + tempname + '">0</h6></div ></div > </div><div class="col-sm-8 pull-right tkt-btn"><div class="pull-right pull-right-mg">' +
                        '&nbsp;&nbsp;' +
                        ...
                        '<i class="fas fa-ticket-alt"></i><span class="btn-text">Open Ticket</span></button></div></div></div></tr></tbody ></table > <select class="form-control tkt-opt-hide" id="combo_' + tempname + '"></select >';
